...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React12.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React12.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React12.useMemo(() => storageManager?.({
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RIB5FA5O.js.map
